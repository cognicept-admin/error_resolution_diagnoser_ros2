...
void StateManager::check_message(std::string agent_type, std::string robot_code, const rcl_interfaces::msg::Log::SharedPtr data, json::value telemetry)
{
...
void StateManager::check_message_ecs(std::string robot_code, const rcl_interfaces::msg::Log::SharedPtr data, json::value telemetry)
{
...
void StateManager::check_message_ert(std::string robot_code, const rcl_interfaces::msg::Log::SharedPtr data, json::value telemetry)
{
...
void StateManager::check_message_ros(std::string robot_code, const rcl_interfaces::msg::Log::SharedPtr data, json::value telemetry)
{
