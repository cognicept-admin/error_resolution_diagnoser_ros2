...
public:
    ...
    void check_message(std::string, std::string, const rcl_interfaces::msg::Log::SharedPtr, web::json::value); // Entry point to state management that calls the correct variant of check_message*
    void check_message_ecs(std::string, const rcl_interfaces::msg::Log::SharedPtr, web::json::value);          // State management in case of ECS feedback
    void check_message_ert(std::string, const rcl_interfaces::msg::Log::SharedPtr, web::json::value);          // State management in case of ERT feedback
    void check_message_ros(std::string, const rcl_interfaces::msg::Log::SharedPtr, web::json::value);          // State management in case of a ROS direct feed
